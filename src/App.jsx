      ...
      ================================================= */}
        ...
        <section className="hero">
          ...
          <div className="container hero-content">
            ...
            <div className="academy-label">QNAYDS ACADEMY</div>
            ...
            <p className="hero-description">
              Lesson Plans, Question Papers, Presentations, Worksheets, Study
              Materials എന്നിവ തയ്യാറാക്കാൻ AI എങ്ങനെ practical ആയി ഉപയോഗിക്കാം
              എന്ന് പഠിക്കാം.
            </p>
